<!-- ============================================================= -->
<!--  GITHUB PROFILE README  ::  Dr Temi Priscilla Jokotola        -->
<!--  Tip: replace every {{PLACEHOLDER}} with your real link.      -->
<!-- ============================================================= -->
...
| Communication and Influence | Leadership and Delivery | Analytical Mindset |
| :-- | :-- | :-- |
| Data storytelling | Stakeholder management | Critical thinking |
| Executive reporting | Cross-functional collaboration | Structured problem solving |
| Technical writing | Project and timeline ownership | Hypothesis-driven analysis |
| Mentoring and teaching | Agile ways of working | Attention to detail |
